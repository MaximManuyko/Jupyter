...
# Построение графика распределения miles_int
plt.figure(figsize=(b, b * 0.3))
sns.set(style="whitegrid")
sns.histplot(df_copy['miles_int'], kde=True)

# Добавление сетки и подписей на русском языке
plt.grid(True)
...
# Построим гистограмму распределения price_int
sns.histplot(df_copy['price_int'], kde=True, bins=50, color='skyblue')

# Добавим сетку
plt.grid(True)

# Установим подписи на русском языке
...
plt.xticks(rotation=45, ha='right')
plt.xlabel('Бренд')
plt.ylabel('Средний пробег. мили')
